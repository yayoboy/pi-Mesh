...
;(function() {
  ...
  function build() {
    ...
    _kbd.id = 'vkbd'
    _kbd.style.cssText = 'display:none;position:fixed;bottom:0;left:var(--nav-w,0);right:0;z-index:9999;' +
      'background:var(--panel);border-top:1px solid var(--border);padding:0 2px 4px;touch-action:manipulation;'
